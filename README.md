...
The code, tests and benchmarks are written by PallasKat (Christophe Charpilloz, [MeteoSchweiz](http://www.meteoswiss.admin.ch/home.html)) and the mathematical implementation are inspired by the one proposed by [Nvidia Corporation](http://www.nvidia.com).
